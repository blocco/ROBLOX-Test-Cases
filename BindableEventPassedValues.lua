...
function TypeTestCase(var, typ, description)
	return {
...
local testCaseTypes = {
	TypeTestCases = {
		TypeTestCase(0,									"number", 	"Lua number");
		TypeTestCase("",								"string", 	"Lua string");
		TypeTestCase({},								"table", 	"Lua table");
		TypeTestCase(nil, 								"nil", 		"Lua nil");
		TypeTestCase(function() end, 					"function", "Lua function");
		TypeTestCase(coroutine.create(function() end), 	"thread", 	"Lua thread");
		TypeTestCase(newproxy(true), 					"string", 	"Lua userdata");
		TypeTestCase(game, 								"userdata", "Roblox object");
		TypeTestCase(game.Changed, 						"userdata", "Roblox event");
		TypeTestCase(game.IsA, 							"function", "Roblox function");
		TypeTestCase(game.WaitForChild, 				"function", "Roblox yield function");
		TypeTestCase(game.ClassName, 					"string", 	"Roblox property");
	};
	DuckEqualTestCases = {
